...
/// @title A combination of unit, mock and fuzz tests for Rebase Token and Vault
/// @author lamb
contract RebaseTokenTest is Test {
    ...
    function testDepositLinear(uint256 amount) public {
        ...
        // 5. check the interest rate is linear
    ...
    function testRedeemAfterTimePassed(uint256 depositAmount, uint256 time) public {
        time = bound(time, 1000 seconds, type(uint96).max); // max time of 136 years
    ...
    function testTransfer(uint256 amount, uint256 amountToSend) public {
        ...
        // check the user interest rate has been inherited (5e10 and not 4e10)
